...
/// UI 上显示的名称
 ...
 String get path; List<MinecraftGame> get versions;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DotMinecraftFolder&&(identical(other.name, name) || other.name == name)&&(identical(other.path, path) || other.path == path)&&const DeepCollectionEquality().equals(other.versions, versions));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,path,const DeepCollectionEquality().hash(versions));

@override
String toString() {
  return 'DotMinecraftFolder(name: $name, path: $path, versions: $versions)';
}
...
@useResult
$Res call({
 String name, String path, List<MinecraftGame> versions
});
...
/// Create a copy of DotMinecraftFolder
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? path = null,Object? versions = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String path,  List<MinecraftGame> versions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DotMinecraftFolder() when $default != null:
return $default(_that.name,_that.path,_that.versions);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String path,  List<MinecraftGame> versions)  $default,) {final _that = this;
switch (_that) {
case _DotMinecraftFolder():
return $default(_that.name,_that.path,_that.versions);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String path,  List<MinecraftGame> versions)?  $default,) {final _that = this;
switch (_that) {
case _DotMinecraftFolder() when $default != null:
return $default(_that.name,_that.path,_that.versions);case _:
  return null;
...
class _DotMinecraftFolder extends DotMinecraftFolder {
  const _DotMinecraftFolder({this.name = '', this.path = '', final  List<MinecraftGame> versions = const []}): _versions = versions,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DotMinecraftFolder&&(identical(other.name, name) || other.name == name)&&(identical(other.path, path) || other.path == path)&&const DeepCollectionEquality().equals(other._versions, _versions));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,path,const DeepCollectionEquality().hash(_versions));
...
/// Create a copy of DotMinecraftFolder
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? path = null,Object? versions = null,}) {
